    ...
    return (
        <div className="hover:bg-slate-900 cursor-pointer border-slate-800 flex-wrap gap-4 p-2 border justify-center items-center w-full max-w-sm rounded-lg shadow">
            ...
            <div className="p-4 space-y-2">
                <a href="#">
                    <h5 className="truncate uppercase text-xl font-semibold tracking-tight  text-white">{data.title}</h5>
                </a>
                ...
                <div className="flex items-center justify-between">
                    ...
                    <a href="#" className="flex gap-x-2 text-white focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-4 py-2 md:px-3 md:py-1.5 lg:px-5 lg:py-2.5 text-center bg-rose-500 hover:bg-rose-600 focus:ring-rose-800">
