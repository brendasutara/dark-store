function Card() {
    return (
        <div className="flex-wrap justify-center items-center w-full max-w-sm rounded-lg shadow m-10">
            <a href="#">
                <figure className="relative">
                    <img className="rounded-lg" src="https://mir-s3-cdn-cf.behance.net/project_modules/fs/08d9aa141708781.6258b4f258a52.png" alt="product image" />
