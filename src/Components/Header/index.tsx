...
const Header = () => {
    ...
    return (
        <article className="relative mx-auto flex flex-col justify-center items-center w-10/12 md:w-full h-screen">
            ...
            <img src="./src/assets/auriculares/headphones-pink2.png" alt="headphones" className={`z-10 w-4/5 md:w-auto rotate-12 transition-transform duration-500 ${scrolled ? 'rotate-0' : ''}`} />
            ...
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="rgb(251 113 133)" className="absolute size-8 mb-8 md:mb-2 bottom-0">
